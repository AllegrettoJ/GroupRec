...
def addVisitDuration(dfVisits):
    ...
    dfavgDuration = dfVisits.groupby('poiID')['visitDuration'].mean().reset_index(name='avgDuration')
    dfVisits = dfVisits.merge(dfavgDuration, left_on = 'poiID', right_on = 'poiID')
